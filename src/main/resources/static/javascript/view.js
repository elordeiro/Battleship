...
function colorSunkShips(ship, alignment, x, y) {
    ...
    const grid = pollData.activePlayer === player.name
        ? "player-grid-"
        : "opponent-grid-";
...
function updateOceanGrid(cellIdx) {
...
function updateTargetGrid(cellIdx) {
...
function resetGame() {
    ...
    targetGrid === null || targetGrid === void 0 ? void 0 : targetGrid.replaceChildren();
    createGrid("player-grid");
    createGrid("opponent-grid");
    playingRoom === null || playingRoom === void 0 ? void 0 : playingRoom.replaceChildren();
    playingRoom === null || playingRoom === void 0 ? void 0 : playingRoom.appendChild(shipsDiv);
    playingRoom === null || playingRoom === void 0 ? void 0 : playingRoom.appendChild(outputDiv);
...
function handleGameOver() {
    ...
    restart === null || restart === void 0 ? void 0 : restart.addEventListener("click", resetGame);
}
function handleShipSunk() {
    ...
    if (pollData.activePlayer === player.name) {
        ...
        consoleOutput.innerHTML +=
            "Click on a cell in Target Grid to attack!\n";
        colorSunkShips(ship.toLowerCase(), alignment.toLowerCase(), parseInt(x), parseInt(y));
    }
    else {
...
function processNewState() {
    ...
    if (pollData.activePlayer !== player.name) {
        ...
        if (DEBUG) {
            while (true) {
                const randomCell = document.getElementById("opponent-grid-" + rand());
                if (randomCell.dataset.attacked === undefined) {
                    setTimeout(function () {
                        randomCell === null || randomCell === void 0 ? void 0 : randomCell.click();
                    }, 200);
                    break;
                }
            }
