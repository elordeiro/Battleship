...
let player: Player = { name: "", ships: [] }; // player object
...
let selectedShip: SelectedShip = {
    type: "none",
    length: 0,
    alignment: "horizontal",
    gridCell: 0,
};
let droppedShip: SelectedShip = {
    type: "none",
    length: 0,
    alignment: "horizontal",
    gridCell: 0,
...
function Player(name): void {
    this.name = name;
    this.ships = [];
}

function Ship(type, coordinates, alignment): void {
    this.type = type;
